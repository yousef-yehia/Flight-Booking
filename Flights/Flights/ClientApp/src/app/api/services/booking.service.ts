...
import { listByIdBooking } from '../fn/booking/list-by-id-booking';
import { ListByIdBooking$Params } from '../fn/booking/list-by-id-booking';
import { listByIdBooking$Plain } from '../fn/booking/list-by-id-booking-plain';
import { ListByIdBooking$Plain$Params } from '../fn/booking/list-by-id-booking-plain';
...
export class BookingService extends BaseService {
  ...
  /** Path part for operation `listByIdBooking()` */
  static readonly ListByIdBookingPath = '/Booking/{id}';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `listByIdBooking$Plain()` instead.
   *
   * This method doesn't expect any request body.
   */
  listByIdBooking$Plain$Response(params: ListByIdBooking$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<BookingRm>>> {
    return listByIdBooking$Plain(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `listByIdBooking$Plain$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  listByIdBooking$Plain(params: ListByIdBooking$Plain$Params, context?: HttpContext): Observable<Array<BookingRm>> {
    return this.listByIdBooking$Plain$Response(params, context).pipe(
      map((r: StrictHttpResponse<Array<BookingRm>>): Array<BookingRm> => r.body)
    );
  }
  ...
  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `listByIdBooking()` instead.
   *
   * This method doesn't expect any request body.
   */
  listByIdBooking$Response(params: ListByIdBooking$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<BookingRm>>> {
    return listByIdBooking(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `listByIdBooking$Response()` instead.
   *
   * This method doesn't expect any request body.
   */
  listByIdBooking(params: ListByIdBooking$Params, context?: HttpContext): Observable<Array<BookingRm>> {
    return this.listByIdBooking$Response(params, context).pipe(
      map((r: StrictHttpResponse<Array<BookingRm>>): Array<BookingRm> => r.body)
    );
  }
