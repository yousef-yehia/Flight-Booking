...
export function findPassenger$Plain(http: HttpClient, rootUrl: string, params: FindPassenger$Plain$Params, context?: HttpContext): Observable<StrictHttpResponse<Passenger>> {
